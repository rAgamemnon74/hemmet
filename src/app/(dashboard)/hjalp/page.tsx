...
**Exempel på jäv:**
• Styrelsen ska upphandla en tjänst och din firma lämnar offert
• Din egen renoveringsansökan behandlas
• Din makes/makas andrahandsansökan behandlas
• En störningsanmälan gäller dig eller din granne

**Vad gör du?**
1. Säg till ordförande att du är jävig
2. Ange anledningen
3. Lämna rummet (eller avstå från att delta i beslutet)
4. Systemet registrerar din jävsdeklaration automatiskt

**Varför spelar det roll?**
Om du deltar i ett beslut där du är jävig kan beslutet ogiltigförklaras. Det skyddar dig, föreningen och den berörda personen.

**Tips:** Hellre deklarera jäv en gång för mycket än en gång för lite.`,
  },
  {
    id: "gdpr",
